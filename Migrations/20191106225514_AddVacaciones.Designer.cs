...
{
    [DbContext(typeof(Data.DepPuestoContexto))]
    [Migration("20191106225514_AddVacaciones")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_BU.Models.Contrato", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("API_BU.Models.Departamento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("API_BU.Models.Empleado", b =>
                {
            ...
            modelBuilder.Entity("API_BU.Models.Empresa", b =>
                {
                    b.Property<int>("EmpresaID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("API_BU.Models.Horario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("API_BU.Models.ProgHorario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("ProgHorario");
                });

            modelBuilder.Entity("API_BU.Models.Puesto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("API_BU.Models.Reloj", b =>
                {
            ...
            modelBuilder.Entity("API_BU.Models.Vacaciones", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("D_restantes");

                    b.Property<int>("D_solicita");

                    b.Property<int>("Descansos");

                    b.Property<int>("Dias_disp");

                    b.Property<int>("Dias_periodo");

                    b.Property<DateTime>("Fh_canc");

                    b.Property<DateTime>("Fh_fin");

                    b.Property<DateTime>("Fh_inicio");

                    b.Property<DateTime>("Fh_solic");

                    b.Property<int>("Id_emp");

                    b.Property<string>("Obs_can");

                    b.Property<string>("Observaciones");

                    b.Property<int>("Periodo");

                    b.Property<int>("UsuSol");

                    b.Property<int>("Usu_can");
            ...
            modelBuilder.Entity("API_BU.Models.Puesto", b =>
                {
                    b.HasOne("API_BU.Models.Departamento", "Departamento")
                        .WithMany("Puesto")
